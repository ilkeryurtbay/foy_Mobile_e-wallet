...
class _$_CreditCardResponse implements _CreditCardResponse {
  const _$_CreditCardResponse({this.Response});
  ...
  @override
  String toString() {
    return 'DeleteCreditCardResponse(Response: $Response)';
  }
...
abstract class _CreditCardResponse implements DeleteCreditCardResponse {
  const factory _CreditCardResponse({final GeneralResponse? Response}) =
